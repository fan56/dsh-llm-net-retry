...
const ownName = pkg.name // @aiwayds/dsh-llm-net-retry

const work = mkdtempSync(path.join(tmpdir(), 'dsh-net-retry-smoke-'))
...
if (dumpAfter.stdout.includes('dsh-llm-net-retry')) {
